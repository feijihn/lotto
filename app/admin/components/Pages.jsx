    ...
    return (
      <div className={'panel-pages'}>
        ...
        <form action="/modify-content" method="post">
          ...
          <textarea rows="5" cols="120" name="introText" defaultValue={this.context.store.content[0].text} />
            <h2 className={'text-center'}>Нижний блок </h2>
          <textarea rows="5" cols="120" name="securityText" defaultValue={this.context.store.content[1].text} />
